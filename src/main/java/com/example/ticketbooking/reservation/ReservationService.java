...
import com.example.ticketbooking.seat.SeatRepository;
...
public class ReservationService {
    ...
    public ReservationService(ReservationRepository reservationRepository, JpaScreeningRepository screeningRepository, SeatRepository seatRepository, UserRepository userRepository) {
    ...
    public ReservationResponseDTO saveReservation(@RequestBody ReservationRequestDTO reservationRequest) {
...
//            if (leftLeftNeighbor == null || rightRightNeighbor == null) {
        ...
        List<SeatView> seatViewList = new ArrayList<>();
        reservationSeats.forEach( seat -> {
            seatViewList.add(new SeatView(seat.getSeatRow(), seat.getSeatNumber(), seat.getTicketType()));
        });
